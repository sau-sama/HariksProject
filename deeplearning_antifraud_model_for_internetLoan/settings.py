...
ROOT_URLCONF = 'deeplearning_antifraud_model_for_internetLoan.urls'
...
WSGI_APPLICATION = 'deeplearning_antifraud_model_for_internetLoan.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'deeplearning_antifraud_model_for_internetLoan',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
