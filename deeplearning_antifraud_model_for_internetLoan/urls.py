"""deeplearning_antifraud_model_for_internetLoan URL Configuration
...
from deeplearning_antifraud_model_for_internetLoan import settings
...
urlpatterns = [
    ...
    url(r'^Find_Internet_Loan_Prediction_Type_Ratio/$', serviceprovider.Find_Internet_Loan_Prediction_Type_Ratio,name="Find_Internet_Loan_Prediction_Type_Ratio"),
    ...
    url(r'^View_All_Antifraud_Model_for_Internet_Loan_Prediction/$', serviceprovider.View_All_Antifraud_Model_for_Internet_Loan_Prediction, name="View_All_Antifraud_Model_for_Internet_Loan_Prediction"),
